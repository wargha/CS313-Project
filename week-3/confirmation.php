...
<body>
    ...
    <section id="welcome-shopping" class="container col">
        <div class="container col welcome">
            <h4>Your order was processed successfully!</h4>
            <p>Thank you for doing business with us! A confirmation letter will be sent to the following address: </p>
          
            <?php
            echo "<p>" .  $_GET["street"] . ", " . $_GET["city"] . " - " . $_GET["zip"];
            ?>
